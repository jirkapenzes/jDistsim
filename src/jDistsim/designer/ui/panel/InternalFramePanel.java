...
public class InternalFramePanel extends JPanel {
    ...
    private static final class GradientPanel extends JPanel {
        ...
        private GradientPanel(LayoutManager layoutManager, Color background) {
            super(layoutManager);
    ...
    public InternalFramePanel(String title) {
        this(null, title, null, null);
    }

    public InternalFramePanel(Icon icon, String title) {
        this(icon, title, null, null);
    }

    public InternalFramePanel(String title, JToolBar bar, JComponent content) {
        this(null, title, bar, content);
    }

    public InternalFramePanel(Icon icon, String title, JToolBar bar, JComponent content) {
