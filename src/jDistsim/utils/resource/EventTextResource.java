 ...
 * Time: 20:31
 */
public class EventTextResource {

    public static String EMPTY_EVENT_DESCRIPTION_TITLE = "Information about process";
    public static String EMPTY_EVENT_DESCRIPTION_TEXT = "<html>Click on the component in the toolbox, and there appears a short information.</html>";
